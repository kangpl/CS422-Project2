...
//    val lineitem = sqlContext.read.load("/Users/yawen/Documents/Scala/tpch_parquet_sf1/lineitem.parquet")
    ...
    val date = Executor.calcDate("2019-05-05", "month", 1, true)

//    val trueResult = Executor.execute_Q10(desc_, session, List("3"))
...
//    var desc2 = new Description
    desc_.samples = tmp._1
    desc_.sampleDescription = tmp._2
    //
